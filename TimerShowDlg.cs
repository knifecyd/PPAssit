      ...
      */      
       ...
       // static Boolean autoSendPriceCmd = false;
        ...
        private void SendPricetimer_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                if ("11:29:30".Equals(textHH.Text.ToString() + ":" + textMM.Text.ToString() + ":" + textSS.Text.ToString()))
                    price_30 = this.textPrice.Text.ToString();


                if (!dic.ContainsKey(textMM.Text.ToString() + ":" + textSS.Text.ToString()) && price_30 != null)
                {
                    // dic.Add(textMM.Text.ToString() + ":" + textSS.Text.ToString(), this.textPrice.Text.ToString());
                    dic.Add(textMM.Text.ToString() + ":" + textSS.Text.ToString(), this.textPrice.Text.ToString());


                    Log.Text = "";
                    foreach (KeyValuePair<String, String> pair in dic)
                        Log.Text = Log.Text + "|" + (Convert.ToInt32(pair.Value) - Convert.ToInt32(price_30)).ToString();
                }
        ...
        {
            //Log.Text = ("subming : " + submitingPrice +" currentPrice " +  currentPrice);
            try
            {
                ...
                {
                    if ( Convert.ToInt32(submitingPrice) - Convert.ToInt32 ( currentPrice) >= Convert.ToInt32(detectPriceDis))
                    {
                        
                        return true;
                    }
                }
                this.tAutoDetectorextBox.Text = currentTime + "|" + detectTime + "|" + detectPriceDis+ "|" + (Convert.ToInt32(submitingPrice) - Convert.ToInt32(currentPrice)).ToString();
            }
            catch (Exception e)
            {
        ...
        private void button4_Click_2(object sender, EventArgs e)
        {
            ...
            //ListForm f = new ListForm(dic);
            //f.setTimePriceList(dic);
            //f.ShowDialog();
